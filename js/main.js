...
(function ($) {
      ...
      $googleMaps.each(function () {
        ...
        geocoder.geocode(
          ...
          function (data) {
            ...
            // -12.08974016331805, -76.85520026921121;
            // -12.087484614954432, -76.853258349958;
            // -12.09010734380982, -76.8514559055683;

            map = new google.maps.Map($map[0], settings);
            var triangleCoords = [
              { lat: -12.08974016331805, lng: -76.85520026921121 },
              { lat: -12.087484614954432, lng: -76.853258349958 },
              { lat: -12.09010734380982, lng: -76.8514559055683 },
            ];
  ...
  function documentReadyInit() {
    ...
    if ($().localScroll) {
      $(
        ".top-nav > ul, .mainmenu_side_wrapper > ul, #land, .animated-arrow, .comments-link"
      ).localScroll({
        duration: 900,
  ...
  function windowLoadInit() {
    ...
    $(".isotope-wrapper").each(function (index) {
      ...
      var layoutMode = $container.hasClass("masonry-layout")
        ? "masonry"
        : "fitRows";
      var columnWidth = $container.children(".col-md-4").length
        ? ".col-md-4"
        : false;
      $container.isotope({
